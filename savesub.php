  ...
  <tr>
    ...
    <th>ปุ่ม</th>
              ...
              <?php 
                ...
                $check1 = $_SESSION['check'];
              //ดึงข้อมูลจากตาราง member
              $select_stmt = $db->prepare("SELECT * from subject WHERE check1 = $check1");
              $select_stmt->execute();
        ...
        <th> <a href="savesub_db1.php?check_id=<?php echo $row["ids"]; ?>" class ="btn btn-primary">ตรวจสอบ</a></th>
