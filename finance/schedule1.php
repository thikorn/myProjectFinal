...
<table style="width:100%">
  ...
  <?php 
        ...
        <th> <a href="schedule1_db.php?check_ids=<?php echo $row["ids"];?>" class ="btn btn-primary" target ="_blank">PDF</a> </th>
        <th> <a href="schedule1_month_db.php?check_ids=<?php echo $row["ids"];?>" class ="btn btn-primary" target ="_blank">PDF</a> </th>
