...
//ดึงข้อมูลจากตาราง subject
        ...
        $select_stmt = $db->prepare("SELECT * from subject WHERE (check2>0  OR check2=-1) AND classLab != 0");
        $select_stmt->execute();
        ...
        <th> <a href="report3_db.php?check_ids=<?php echo $row["ids"];?>" class ="btn btn-primary" target ="_blank">PDF</a> </th>
