...
<?php include('../decorate_department.php')?>
    ...
    <form action="createwithdraw5.5_db.php" method="post"> 

    <label for="" class="col-sm-4 control-label">เลือกอาจารย์ *</label>
    <div class="col-sm-3">
<select name="s_teacher" class="form-control" required>
    <option value="" selected="selected">เลือกอาจารย์</option>
    <option value="teacher1">อาจารย์พิเศษ</option>
    <option value="teacher2">อาจารย์ประจำ</option>
