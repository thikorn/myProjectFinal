<?php 
    ...
    if (isset($_REQUEST['update_ids'])) {
        try {
            ...
            $checksuccess = $_REQUEST['checksuccess'];
        ...
        if (empty($nameSubject_up)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    ...
                    ,compensationlec = :compensationlec_up ,compensationlab = :compensationlab_up ,fiscaYear = :fiscaYear_up , $check = :checksuccess
                     WHERE ids = :ids");
                    ...
                    $update_stmt->bindParam(':checksuccess', $checksuccess);
...
<div class="container">
    ...
    <table cellspacing="4" cellpadding="4" style=" border:1px DASHED #8ABB39;background-color: #8ABB39" width=470><tbody><tr><td align="center" valign="middle" style="background-color: #A2CD5A"><table border="0" cellspacing="8" cellpadding="8" width=1000 style=" background-color: #BCEE68"><tbody><tr><td align="center" style=" border:2px DASHED #CAFF70;background-color: #CAFF70"><font size=2>
