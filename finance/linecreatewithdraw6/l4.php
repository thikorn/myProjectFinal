...
if($resultarray[3]["$nametime1"]<="08:30:00" and $resultarray[3]["$nametime11"]<="08:30:00"){
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
   $html .= '<div style="position:absolute;top:'.$line.'px;left:'.$leftdate.'px;width:300px;"><p>'. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
...
else if($resultarray[3]["$nametime1"]<"08:30:00" and $resultarray[3]["$nametime11"]>"16:00:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
...
else if($resultarray[3]["$nametime1"]<"08:30:00" and $resultarray[3]["$nametime11"]>"12:30:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
   $time111 = date("H.i", strtotime("08:30:00"));            
...
else if($resultarray[3]["$nametime1"]<"08:30:00" and $resultarray[3]["$nametime11"]>"08:30:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
   $time111 = date("H.i", strtotime("08:30:00"));            
...
else if($resultarray[3]["$nametime1"]<"12:30:00" and $resultarray[3]["$nametime11"]>"16:00:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
...
else if($resultarray[3]["$nametime1"]<"16:00:00" and $resultarray[3]["$nametime11"]>"16:00:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
...
}else if($resultarray[3]["$nametime1"]>="08:30:00" and $resultarray[3]["$nametime11"]<="12:00:00"){
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
   $html .= '<div style="position:absolute;top:'.$line.'px;left:'.$leftdate.'px;width:300px;"><p>'. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$lefttime1in.'px;width:300px;"><p>'.$time1 .'-'. "$time11" .'</p></div>';
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftcount1in.'px;width:300px;"><p>'. number_format( caltime($time11,$time1) , 2 ) .'</p></div>';
   $tohoursin = $tohoursin + caltime($time11,$time1);
}else if($resultarray[3]["$nametime1"]>="13:00:00" and $resultarray[3]["$nametime11"]<="16:00:00"){
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
   $html .= '<div style="position:absolute;top:'.$line.'px;left:'.$leftdate.'px;width:300px;"><p>'. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$lefttime1out.'px;width:300px;"><p>'.$time1 .'-'. "$time11" .'</p></div>';
   ...
   $hour1 = 60;
   for($i=1;$i<=$totime;$i++){
       $timecal12 = date("H.i", strtotime($resultarray[3]["$nametime1"])+$hour1*60);
       //10.00-14.00
       ...
       //10.00-12.30
         ...
         /*
           $html .= '<div style="position:absolute;top:'.$line.'px;left:275px;width:300px;"><p>'. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
 ...
 if($resultarray1[3]["datenlab"]==null){
   $nametime1 = "timelab1";
...
if($resultarray1[3]["$nametime1"]<="08:30:00" and $resultarray1[3]["$nametime11"]<="08:30:00"){
   $time1 = date("H.i", strtotime($resultarray1[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray1[3]["$nametime11"]));
   $html .= '<div style="position:absolute;top:'.$line.'px;left:'.$leftdate.'px;width:300px;"><p>'. DateThai($resultarray1[3]["$namedate"]) .'</p></div>';
...
else if($resultarray1[3]["$nametime1"]<"08:30:00" and $resultarray1[3]["$nametime11"]>"16:00:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray[3]["$nametime11"]));
   $time111 = date("H.i", strtotime("08:30:00"));            
...
else if($resultarray1[3]["$nametime1"]<"08:30:00" and $resultarray1[3]["$nametime11"]>"12:30:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray1[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray1[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray1[3]["$nametime11"]));
   $time111 = date("H.i", strtotime("08:30:00"));            
...
else if($resultarray1[3]["$nametime1"]<"08:30:00" and $resultarray1[3]["$nametime11"]>"08:30:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray1[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray1[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray1[3]["$nametime11"]));
   $time111 = date("H.i", strtotime("08:30:00"));            
...
else if($resultarray1[3]["$nametime1"]<"12:30:00" and $resultarray1[3]["$nametime11"]>"16:00:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p>'. DateThai($resultarray1[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray1[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray1[3]["$nametime11"]));
   $time111 = date("H.i", strtotime("12:00:00"));   
...
else if($resultarray1[3]["$nametime1"]<"16:00:00" and $resultarray1[3]["$nametime11"]>"16:00:00"){
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftdate.'px;width:300px;"><p> '. DateThai($resultarray1[3]["$namedate"]) .'</p></div>';
   $time1 = date("H.i", strtotime($resultarray1[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray1[3]["$nametime11"]));
   $time111 = date("H.i", strtotime("16:00:00"));            
...
}else if($resultarray1[3]["$nametime1"]>="08:30:00" and $resultarray1[3]["$nametime11"]<="12:00:00"){
   $time1 = date("H.i", strtotime($resultarray1[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray1[3]["$nametime11"]));
   $html .= '<div style="position:absolute;top:'.$line.'px;left:'.$leftdate.'px;width:300px;"><p>'. DateThai($resultarray1[3]["$namedate"]) .'</p></div>';
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$lefttime1inlab.'px;width:300px;"><p>'.$time1 .'-'. "$time11" .'</p></div>';
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$leftcount1in.'px;width:300px;"><p>'. number_format( caltimelab($time11,$time1) , 2 ) .'</p></div>';
   $tohoursin = $tohoursin + caltimelab($time11,$time1);
}else if($resultarray1[3]["$nametime1"]>="13:00:00" and $resultarray1[3]["$nametime11"]<="16:00:00"){
   $time1 = date("H.i", strtotime($resultarray1[3]["$nametime1"]));
   $time11 = date("H.i", strtotime($resultarray1[3]["$nametime11"]));
   $html .= '<div style="position:absolute;top:'.$line.'px;left:'.$leftdate.'px;width:300px;"><p>'. DateThai($resultarray1[3]["$namedate"]) .'</p></div>';
   $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$lefttime1outlab.'px;width:300px;"><p>'.$time1 .'-'. "$time11" .'</p></div>';
   ...
   $hour1 = 60;
   for($i=1;$i<=$totime;$i++){
       $timecal12 = date("H.i", strtotime($resultarray1[3]["$nametime1"])+$hour1*60);
       //10.00-14.00
       if($timecal12 == "12.00" and $time11 > "12.30" ){
           $html .= '<div style="position:absolute;top:'.$line.'px;left:'.$leftdate.'px;width:300px;"><p>'. DateThai($resultarray1[3]["$namedate"]) .'</p></div>';
           $html .= '<div style="position:absolute;top: '.$line.'px;left:'.$lefttime1inlab.'px;width:300px;"><p>'.$time1 .'-'. "$time111" .'</p></div>';
