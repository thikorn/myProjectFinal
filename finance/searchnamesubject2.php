...
<head>
    ...
    <title>หน้าค้นหาจากรายชื่อวิชา</title>
   ...
   <hr>
                ...
                <?php 
                    ...
                    if(isset($_POST['search'])){
                        ...
                        $sql = "SELECT * FROM subjectall WHERE nameSubject LIKE '%$searchKey%'";
                        $sql2 = "SELECT * FROM finance  WHERE nameSubject LIKE '%$searchKey%'";
                    }else{
