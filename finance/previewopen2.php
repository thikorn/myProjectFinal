...
<?php include('../decorate_department.php') ?> 
    ...
    <h1>บันทึกข้อความขอเปิดรายวิชา</h1>
              ...
              <form action="createpreviewopen_db.php" method="post"> 

          <br>
              
          <p>รหัสวิชา : <?php     echo $_SESSION['code'];?> </p>
          <p>ชื่อวิชา : <?php     echo $_SESSION['subname'];?> </p>
          <p>เลข อว(ขอเปิดรายวิชา) : <?php   echo $_SESSION['Ov2'];?> </p>
          <?php
        ...
        $strDate =  $dateov2;
          ...
          <p>ภาควิชาที่ติดต่อขอเปิด : <?php   echo $_SESSION['dapartmentreq'];?> </p>
