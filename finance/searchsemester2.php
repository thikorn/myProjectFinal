...
<head>
    ...
    <title>หน้าค้นหาจากภาคการศึกษา</title>
   ...
   <hr>
                ...
                <?php 
                    ...
                    if(isset($_POST['search'])){
                        ...
                        $sql = "SELECT * FROM subjectall LEFT JOIN finance ON subjectall.ids = finance.ids WHERE semester LIKE '%$searchKey%'";
            ...
            <tr>
                ...
                <td>เดือนที่ 5</td>
					...
					<tr>
                        ...
                        ?>
                        <th class="text-center "> <?php echo number_format($amountwithdrawTotal2)?> </th>
                        <?php 
                        ...
                        ?>
                        <th class="text-center "> <?php echo number_format($amountwithdrawTotal3)?> </th>  
                        <?php 
                        ...
                        ?>
                        <th class="text-center "> <?php echo number_format($amountwithdrawTotal4)?> </th>  
                        <?php 
                        ...
                        ?>
                        <th class="text-center "> <?php echo number_format($amountwithdrawTotal5)?> </th>  
                        <?php 
                        $amountlecreal = $row->amountlecreal;
                        $amountlabreal = $row->amountlabreal;
                        $amountwithreal = $amountlecreal + $amountlabreal;
                        ?>
                        <th class="text-center "> <?php echo number_format($amountwithreal)?> </th> 
                        <th> <?php echo $row->numberOv1?> </th>
                                    </tr>
                                    <?php } ?>
                    <?php } ?>
				</table>
              ...
              if($row_cnt == 0){ ?>
                  ...
                  <p  class="alert alert-secondary width" role="alert">ไม่พบภาคการศึกษานั้น</p>
            <?php
              }
              ?>
<br>
