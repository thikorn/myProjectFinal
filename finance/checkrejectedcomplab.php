<?php 
    ...
    if (isset($_REQUEST['update_ids'])) {
        try {
            ...
            $_SESSION['idteaching'] =$_REQUEST['idteaching'];

            $select_stmt = $db->prepare("SELECT * FROM teaching_informationlab WHERE ids = :ids AND id = $idteaching ");
        ...
        if (empty($nameSubject_up)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    ...
                    $update_stmt = $db->prepare("UPDATE teaching_informationlab SET nameSubject = :nameSubject_up, nameTeacher = :nameTeacher_up, $check = :check1 
                    ,datelab = :date_up, timelab1 = :time1_up, timelab11 = :time11_up, datenlab = :daten_up ,timenlab1 = :timen1_up, timenlab11 = :timen11_up
...
<?php 
    ...
    <h4>สิ่งที่ต้องทบทวน คือ <?php echo $rejectedchecklab1 ?></h4>
    ...
    <br>
            ...
            <div class="form-group text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="date" name="date" class="form-control" value="<?php echo $datelab; ?>">
                    </div>
                </div>
            </div>
                <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="time" name="time1" class="form-control" value="<?php echo $timelab1 ?>">
                    </div>
                </div>
            </div>
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="time" name="time11" class="form-control" value="<?php echo $timelab11 ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="date" name="daten" class="form-control" value="<?php echo $datenlab; ?>">
                    </div>
                </div>
            </div>
                <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="time" name="timen1" class="form-control" value="<?php echo $timenlab1 ?>">
                    </div>
                </div>
            </div>
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="time" name="timen11" class="form-control" value="<?php echo $timenlab11 ?>">
                    </div>
                </div>
            </div>
