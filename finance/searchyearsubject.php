   ...
   <hr>
                ...
                <?php 
                    ...
                    if(isset($_POST['search'])){
                        ...
                        $sql = "SELECT * FROM subject LEFT JOIN finance ON subject.ids = finance.ids WHERE yearSubject LIKE '%$searchKey%'";
            ...
            <form action="" method="POST"> 
                    ...
                    <input type="text" name="search" class='form-control' placeholder="Search By Year Subject" value="<?php echo $searchKey; ?>" > 
                    <br>
