...
<head>
    ...
    <title>หน้าค้นหาจากเลข อว.</title>
   ...
   <hr>
                ...
                <?php 
                    ...
                    if(isset($_POST['search'])){
                        ...
                        $sql = "SELECT * FROM subjectall LEFT JOIN finance ON subjectall.ids = finance.ids WHERE numberOv1 LIKE '%$searchKey%'";
            ...
            <form action="" method="POST"> 
                    ...
                    <input type="text" name="search" class='form-control' placeholder="Search By ov" value="<?php echo $searchKey; ?>" > 
                    <br>
     ...
     <col width="2850">
            ...
            <tr>
              ...
              if($row_cnt == 0){ ?>
                  ...
                  <p  class="alert alert-secondary width" role="alert">ไม่พบเลข อว. นั้น</p>
            <?php
              }
              ?>
        <br>
