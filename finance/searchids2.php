   ...
   <hr>
                ...
                <?php 
                    ...
                    if(isset($_POST['search'])){
                        ...
                        $sql = "SELECT * FROM subjectall WHERE ids LIKE '%$searchKey%'";
                        ...
                        $sql2 = "SELECT * FROM subjectall LEFT JOIN finance ON subjectall.ids = finance.ids";
                        $searchKey = "";
                    }
                ...
                <td>เดือนที่ 5</td>
                   ...
                   while($row = mysqli_fetch_object($result) AND $row2 = mysqli_fetch_object($result2)) {
					...
					<tr>
                        ...
                        <td><?php echo $row->date1 ?> <?=date("H:i", strtotime($row->time1));?>-<?=date("H:i", strtotime($row->time11));?></td>
