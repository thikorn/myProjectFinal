...
<h1>กรอกบันทึกข้อความขอสอนชดเชย</h1>
              ...
              <form action="financecomp1_db.php" method="post"> 
              ...
              <label for="ov1" class="col-sm-3 control-label">วันที่สร้างบันทึกข้อความ*</label>
                  <div class="col-sm-3">
                      <input type="date" name="s_datecreate" class="form-control" required  value="<?php echo date('d-m-Y',strtotime($data["congestart"])) ?>" >
                      
                  </div>
                  
              <label for="ov3" class="col-sm-4 control-label">เลข อว(บันทึกข้อความขอสอนชดเชย)*</label>
                  <div class="col-sm-2">
                      <input type="text" name="s_ov4" class="form-control" maxlength="4" required placeholder="Enter OV4">
                  </div>
