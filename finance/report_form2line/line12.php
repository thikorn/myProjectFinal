<?php 
  ...
  $html .= '<div style="position:absolute;top:499px;left:300px;width:800px;"><p> '. $resultarray[11]["topic"] .'</p></div>';
  $html .= '<div style="text-align:center;position:absolute;top:499px;left:615px;"><p> '. $resultarray[11]["classroom"] .'</p></div>';
  $html .= '<div style="position:absolute;top:499px;left:800px;width:800px;"><p> '. $resultarray[11]["note"] .'</p></div>';
  ...
  }else if ($resultarray[11]["daten"] != NULL){
            $date = date("d/m/Y", strtotime($resultarray[11]["daten"]));
            $html .= '<div style="text-align:center;position:absolute;top:499px;left:106px;"><p> '. $date .'</p></div>';
            $time1 = date("H.i", strtotime($resultarray[11]["timen1"]));
            $time11 = date("H.i", strtotime($resultarray[11]["timen11"]));
            $html .= '<div style="text-align:center;position:absolute;top:499px;left:198px;"><p> '. $time1 .' - '. $time11 .'</p></div>';
  }
?>