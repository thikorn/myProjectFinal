<?php 
    ...
    $html .= '<div style="position:absolute;top:184px;left:300;width:800px;"><p> '. $resultarray[0]["topic"] .'</p></div>';
    $html .= '<div style="text-align:center;position:absolute;top:184px;left:615px;"><p> '. $resultarray[0]["classroom"] .'</p></div>';
    $html .= '<div style="position:absolute;top:184px;left:800px;width:800px;"><p> '. $resultarray[0]["note"] .'</p></div>';
