<?php   
        ...
        $html .= '<div style="position:absolute;top:385px;left:300px;width:800px;"><p> '. $resultarray[7]["topic"] .'</p></div>';
        $html .= '<div style="text-align:center;position:absolute;top:385px;left:615px;"><p> '. $resultarray[7]["classroom"] .'</p></div>';
        $html .= '<div style="position:absolute;top:385px;left:800px;width:800px;"><p> '. $resultarray[7]["note"] .'</p></div>';
        ...
        }else if ($resultarray[7]["daten"] != NULL){
            $date = date("d/m/Y", strtotime($resultarray[7]["daten"]));
            $html .= '<div style="text-align:center;position:absolute;top:385px;left:106px;"><p> '. $date .'</p></div>';
            $time1 = date("H.i", strtotime($resultarray[7]["timen1"]));
            $time11 = date("H.i", strtotime($resultarray[7]["timen11"]));
            $html .= '<div style="text-align:center;position:absolute;top:385px;left:198px;"><p> '. $time1 .' - '. $time11 .'</p></div>';
        }
?>