<?php 
   ...
   $html .= '<div style="position:absolute;top:354px;left:300px;width:800px;"><p> '. $resultarray[6]["topiclab"] .'</p></div>';
   $html .= '<div style="text-align:center;position:absolute;top:354px;left:615px;"><p> '. $resultarray[6]["classroomlab"] .'</p></div>';
   $html .= '<div style="position:absolute;top:354px;left:800px;width:800px;"><p> '. $resultarray[6]["notelab"] .'</p></div>';

   if($resultarray[6]["datenlab"] == NULL){
   ...
   }else if ($resultarray[6]["datenlab"] != NULL){
      $date = date("d/m/Y", strtotime($resultarray[6]["datenlab"]));
      $html .= '<div style="text-align:center;position:absolute;top:354px;left:106px;"><p> '. $date .'</p></div>';
      $time1 = date("H.i", strtotime($resultarray[6]["timenlab1"]));
      $time11 = date("H.i", strtotime($resultarray[6]["timenlab11"]));
      $html .= '<div style="text-align:center;position:absolute;top:354px;left:198px;"><p> '. $time1 .' - '. $time11 .'</p></div>';
   }
?>