...
<table>
    ...
    <tr>
       ...
       <?php } ?>
        ...
        <th> <?php if($row["datenlab"]==null){ 
               ?><a href="editaddhourlab.php?update_number=<?php echo $row["numberhourlab"]; ?>&nameback=<?php echo "addhourlab3.php" ?>" class="btn btn-warning">แก้ไข</a><?php
            }else if($row["datenlab"]!=null){
                echo $alert="ชดเชยไปแล้วไม่สามารถแก้ไขได้";
            }
            ?></th>
        <th> <?php if($row["datenlab"]==null){ 
               ?><a href="createcomplab1.php?check_hour=<?php echo $row["numberhourlab"];?>&nameback=<?php echo "addhourlab3.php" ?>" class="btn btn-warning">สอนชดเชย</a><?php
            }else if($row["datenlab"]!=null){
  ...
  $date_arr=array(
   ...
   $date2 = $resultarray['datelab2'];
   $date3 = $resultarray['datelab3'];
...
?>
        ...
        <?php if($a == 1){ ?>
                ...
                <?php $d=strtotime("+$w1 week",$startdate ); ?>
                      <th><?php echo $c  ?></th>
                      <form action="testaddhourlab1_db.php?check_id=<?php echo $c ?>&nameback=<?php echo "addhourlab3.php" ?>&check_date=<?php echo date("Y-m-d", $d)?>&check_time1=<?php echo date("H:i", strtotime($resultarray['timelab1']));?>&check_time11=<?php echo date("H:i", strtotime($resultarray['timelab11']));?>" method="post">
                      <th><?php echo date("d/m/Y", $d)  ?></th>

                      <th><?php echo date("H:i", strtotime($resultarray['timelab1']));?></th>
                      <?php $_SESSION['timelab1']=date("H:i", strtotime($resultarray['timelab1'])); ?>
        ...
        <th><?php echo $c  ?></th>
        <form action="testaddhourlab1_db.php?check_id=<?php echo $c ?>&nameback=<?php echo "addhourlab3.php" ?>&check_date=<?php echo date("Y-m-d", $d2) ?>&check_time1=<?php echo date("H:i", strtotime($resultarray['timelab2']));?>&check_time11=<?php echo date("H:i", strtotime($resultarray['timelab22']));?>" method="post">
        <th><?php echo date("d/m/Y", $d2)  ?></th>
      
        <th><?php echo date("H:i", strtotime($resultarray['timelab2']));?></th>
      
        <th><?php echo date("H:i", strtotime($resultarray['timelab22']));?></th>
      ...
      <th><?php echo $c  ?></th>
      <form action="testaddhourlab1_db.php?check_id=<?php echo $c ?>&nameback=<?php echo "addhourlab3.php" ?>&check_date=<?php echo date("Y-m-d", $d3) ?>&check_time1=<?php echo date("H:i", strtotime($resultarray['timelab3']));?>&check_time11=<?php echo date("H:i", strtotime($resultarray['timelab33']));?>" method="post">
      <th><?php echo date("d/m/Y", $d3)  ?></th>
  
      <th><?php echo date("H:i", strtotime($resultarray['timelab3']));?></th>
    
      <th><?php echo date("H:i", strtotime($resultarray['timelab33']));?></th>
