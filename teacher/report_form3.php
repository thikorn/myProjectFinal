...
<head>
    ...
    <title>ตรวจสอบบันทึกการสอนปฏิบัติ</title>
...
<?php include('../decorate_department.php')?>
    ...
    <h1>บันทึกรายงานการสอนประจำเดือน/ปฏิบัติ</h1>
                <hr>
...
//ดึงข้อมูลจากตาราง subject
        $idT=$_SESSION['idT'];
        $select_stmt = $db->prepare("SELECT * from subject WHERE (check2>0  OR check2=-1) AND  idteacher = :uidT AND classLab != 0");
        ...
        <th> <a href="report_form3_db.php?check_ids=<?php echo $row["ids"];?>" class ="btn btn-primary" target ="_blank">PDF</a> </th>
...
<?php 
        ...
        <?php
          ...
          ?>
                ...
                <br>
                <a href="addhour0.php" class="btn btn-danger">ย้อนกลับ</a>
