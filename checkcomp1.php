...
<?php
    ...
    <h1>บันทึกข้อความขอสอนชดเชย</h1>
          ...
          <p>รหัสวิชา : <?php     echo $_SESSION['code'];?> </p>
            <p>ชื่อวิชา : <?php     echo $_SESSION['subname'];?> <?php echo $_SESSION['nameleclab']; ?>  </p>
            <p>เลข อว(ขออนุมัติสอนชดเชย) : <?php   echo $_SESSION['numberov4'];?> </p>
...
<?php } ?>
      ...
      <?php 
          ...
          if($nameleclab == "lec"){ ?>
              <form action="approve3_db.php" method="post">
          <?php }else if($nameleclab == "lab"){ ?>
              <form action="approvelab3_db.php" method="post">
          <?php }
      ?>
    ...
    <br>
      ...
      <button type="submit" name="submit_rejectedcheckcomp" class="btn btn-warning">ทบทวน</button>
      </form>
      <br>
      <a href="<?php if($namerole=="อาจารย์") 
      {
        echo "checkcomp0.5.php";

      }else {echo "checkcomp.php";}
