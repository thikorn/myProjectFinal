...
<head>
    ...
    <title>ยืนยันบันทึกข้อความขอเปิดรายวิชา</title>
  ...
  <tr>
    ...
    <th>ปุ่ม</th>
              ...
              <?php 
                  ...
                  $select_stmt = $db->prepare("SELECT * from subject WHERE check2 = $check2 AND idteacher = $idT ");
                  $select_stmt->execute();
