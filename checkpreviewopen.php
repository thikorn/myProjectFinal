...
<?php include('decorate_department.php')?>
    ...
    <div class="container">
    <h1><?php echo $_SESSION['btn_submit'];?>บันทึกข้อความขอเปิดรายวิชา</h1>
          
          <hr>
          
          <h5>รายชื่อวิชาที่รอ<?php echo $_SESSION['btn_submit'];?></h5> 
      <br>
  ...
  <tr>
    ...
    <th>ปุ่ม</th>
              ...
              <?php 
                  ...
                  $select_stmt = $db->prepare("SELECT * from subject WHERE check2 = $check2");
                  $select_stmt->execute();
        ...
        <th> <a href="checkpreviewopen1_db.php?check_id=<?php echo $row["ids"]; ?>" class ="btn btn-primary"><?php echo $_SESSION['btn_submit'];?></a></th>
              ...
              <?php 
          if($row_count == 0){ ?>
              <p  class="alert alert-secondary" role="alert">ไม่มีวิชาที่ต้องตรวจสอบ</p>
        <?php
          }
          ?>
