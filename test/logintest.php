...
<?php include('../decorate_department.php') ?> 
    ...
    <div class="container">
        ...
        <div class="from-group row ">
            <label for="code" style = "margin-left:190px">รหัสวิชา*</label>
            <div class="col-sm-2">
                <input type="text" name="s_code" class="form-control"  maxlength="11" required placeholder="Enter Code" >
            </div>
        </div>
        ...
        <div class="form-group row ">
            <label for="yearnisit"  style = "margin-left:105px; margin-top:20px">ปีที่นิสิตสามารถลงได้*</label>
        ...
        <div class="from-group row">
        <label for="myCheck1" style = "margin-left:295px; margin-top:-5px">ปี <?php echo date("Y")-1+543;?> </label>
        ...
        <br>
        <div class="from-group row">
        <label for="myCheck2" style = "margin-left:295px; margin-top:-5px">ปี <?php echo date("Y")-2+543;?> </label>
        ...
        function myFunction2(){
         ...
         <br>
         <div class="from-group row">
        <label for="myCheck3" style = "margin-left:295px; margin-top:-5px">ปี <?php echo date("Y")-3+543;?> </label>
        ...
        function myFunction3(){
         ...
         <br>
         <div class="from-group row">
        <label for="myCheck4" style = "margin-left:295px; margin-top:-5px">ปี <?php echo date("Y")-4+543;?> </label>
        ...
        <div class="form-group row">
        <label for="name" style = "margin-left:210px; margin-top:20px">ชื่อวิชา* </label>
        <div class="col-sm-3">
            <input type="text" name="s_name" style = "margin-top:15px" class="form-control" required placeholder="Enter name">
        </div>
        </div>
        ...
        <div class="form-group">
            <label for="credit" class="col-sm-3 control-label mt-2">หน่วยกิต*</label>
            <div class="col-sm-3">
            <select name="s_credit" class="form-control">
        ...
        <div class="form-group">
            <label for="s_hweekhe" class="col-sm-3 control-label mt-2">ชั่วโมง/สัปดาห์(บรรยาย)*</label>
            <div class="col-sm-3">
            <select name="s_hweekhe" class="form-control" id="myCheck10" onclick="myFunction10()" required >
        ...
        <div class="form-group" style="margin-left:50px">
            <label for="classe" class="col-sm-3 control-label mt-2" style="display:none" id="nameclass5">หมู่บรรยาย*</label>
            <div class="col-sm-3">
        ...
        <div class="form-group"  style="margin-left:50px">
                ...
                <div class="col-s-3"style="margin-left:50px">
                    <label for="myCheck5" class="col-sm-4 control-label " id="namenumdate2" style="display:none">จำนวนวันที่สอนต่อสัปดาห์(บรรายาย)</label>
                    
                    <div class="col-sl-2"style="margin-left:50px">
                        <select name="s_classp8"  class="col-sm-3 form-control " style="display:none"  id="myCheck5" onclick="myFunction5()" >
            ...
            if (checkBox.value != ""){
                ...
                namenumdate2.style.display = "none";
                    ...
                    <div class="form-group">
                        <label for="date" id="nametime5" class="control-label mt-3 ml-5"  style="display:none">เวลาที่สอน(1)*</label>
                            ...
                            <label for="s_time1" class="control-label mt-5 ml-2" id="nametimeb5"  style="display:none">ตั้งแต่*</label>
                            <script src="https://cdn.jsdelivr.net/timepicker.js/latest/timepicker.min.js"></script>
                            <link href="https://cdn.jsdelivr.net/timepicker.js/latest/timepicker.min.css" rel="stylesheet"/>
                                <div class="col-sm-2">
                                    <input type="time" name="s_time1" class="form-control mt-5" id="time5"  style="display:none">
                                    
                                </div>
                            <label for="s_time11" class="control-label mt-5 ml-2" id="nametimea5" style="display:none" >ถึง*</label>
                                <div class="col-sm-2">
                                    <input type="time" name="s_time11" class="form-control mt-5" id="time55" style="display:none">
                                </div>
                        </div>
                ...
                <div class="row"style="margin-left:80px">
                    ...
                    <div class="form-group">
                        ...
                        <label for="s_time2" class="control-label mt-5 ml-2 " style="display:none" id="nametimeb6">ตั้งแต่*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_time2" class="form-control mt-5" id="time6"style="display:none">
                            </div>
                        <label for="s_time22" class="control-label mt-5 ml-2" style="display:none"id="nametimea6">ถึง*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_time22" class="form-control mt-5"  style="display:none" id="time66">
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="s_time3" class="control-label mt-5 ml-2" style="display:none" id="nametimeb7">ตั้งแต่*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_time3" class="form-control mt-5" id="time7"style="display:none">
                            </div>
                        <label for="s_time33" class="control-label mt-5 ml-2" style="display:none"id="nametimea7">ถึง*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_time33" class="form-control mt-5"  style="display:none" id="time77">
                            </div>
                    </div>
        ...
        <div class="form-group">
            <label for="s_hweekhp" class="col-sm-3 control-label mt-2">ชั่วโมง/สัปดาห์(ปฏิบัติ)*</label>
            <div class="col-sm-3">
        ...
        <div class="form-group" style="margin-left:80px">
            <label for="classp" class="col-sm-3 control-label mt-2" id="nameselectlab"style="display:none">เลือกจำนวนหมู่ปฎิบัติ</label>
            <div class="col-sm-2">
            <select name="s_numclassp" class="form-control ml-4"style="display:none"id="numselectlab"onclick="myFunction9()">
            <option value="" selected="selected">เลือกจำนวน</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
        ...
        <div class="form-group"style="margin-left:120px">
            <label for="classp" class="col-sm-4 control-label mt-2" id="nameclasslab1"style="display:none">หมู่ปฏิบัติ(1)</label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
                        <label for="date" class=" control-label" style="display:none"id="namedatelab1">วันที่สอนหมู่ปฏิบัติ(1)*</label>
                            ...
                            <select name="s_datelab1" class="col-sl-3 control-label ml-4 mt-2 form-control" style="display:none" id="datelab1">
                                <option value="" selected="selected">เลือกวัน</option>
                                    <option value="จ.">จันทร์</option>
                                    <option value="อ.">อังคาร</option>
                                    <option value="พ.">พุธ</option>
                    ...
                    <div class="form-group">
                        ...
                        <label for="s_timelab1" class="col-ss-3  mt-4" style="display:none" id="nametimeblab1">ตั้งแต่*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_timelab1" class="form-control mt-4" id="timelab1"style="display:none">
                            </div>
                        <label for="s_timelab11" class="col-ss-3  mt-4" style="display:none"id="nametimealab11">ถึง*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_timelab11" class="form-control mt-4"  style="display:none" id="timelab11">
                            </div>
                    </div>

        <div class="form-group"style="margin-left:120px">
            <label for="classp" class="col-sm-4 control-label mt-2" id="nameclasslab2"style="display:none">หมู่ปฏิบัติ(2)</label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <label for="s_timelab2" class="col-ss-3  mt-4" style="display:none" id="nametimeblab2">ตั้งแต่*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_timelab2" class="form-control mt-4" id="timelab2"style="display:none">
                            </div>
                        <label for="s_timelab2" class="col-ss-3  mt-4" style="display:none"id="nametimealab22">ถึง*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_timelab22" class="form-control mt-4"  style="display:none" id="timelab22">
                            </div>
                    </div>
   
            <div class="form-group"style="margin-left:120px">
            <label for="classp" class="col-sm-4 control-label mt-2" id="nameclasslab3"style="display:none">หมู่ปฏิบัติ(3)</label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <label for="s_timelab3" class="col-ss-3  mt-4 " style="display:none" id="nametimeblab3">ตั้งแต่*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_timelab3" class="form-control mt-4" id="timelab3"style="display:none">
                            </div>
                        <label for="s_timelab3" class="col-ss-3  mt-4" style="display:none"id="nametimealab33">ถึง*</label>
                            <div class="col-sm-2">
                                <input type="time" name="s_timelab33" class="form-control mt-4"  style="display:none" id="timelab33">
                            </div>
                    </div>
        ...
        <label for="compensation" class="col-sm-3 control-label">อัตราค่าตอบแทน(บรรยาย)*</label>
        <div class="col-sm-3">
            <input type="number" name="s_compensationlec" class="form-control" min="0" required placeholder="Enter Compensation">
        </div>

        <label for="compensation" class="col-sm-3 control-label">อัตราค่าตอบแทน(ปฏิบัติ)*</label>
        <div class="col-sm-3">
            <input type="number" name="s_compensationlab" class="form-control" min="0" required placeholder="Enter Compensation">
        </div>

       
        <div class="form-group">
            <label for="s_fiscaly" class="col-sm-3 control-label mt-2">ปีงบประมาณ*</label>
                <div class="col-sm-3">
