      ...
      <?php endif ?>
              ...
              <?php 
                 $idT=$_SESSION['idT'];
                  ...
                  $select_stmt = $db->prepare("SELECT * from teaching_information WHERE check4 = $check4 AND idteacher = $idT");
                  $select_stmt->execute();
  ...
  <tr>
    ...
    <th>ปุ่ม</th>
              ...
              <?php 
                  $idT=$_SESSION['idT'];
                  $check4 = $_SESSION['check4'];
                  $select_stmt = $db->prepare("SELECT * from teaching_informationlab WHERE check4lab = $check4 AND idteacher = $idT");
                  $select_stmt->execute();
