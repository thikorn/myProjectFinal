    ...
    <th>ปุ่ม</th>
      ...
      <?php endif ?>
              ...
              <?php 
                  ...
                  $select_stmt = $db->prepare("SELECT * from finance WHERE check51 = $check5  ");
                  $select_stmt->execute();
              ...
              while($row = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                <th> <a href="checkwithdraw1_db.php?check_id=<?php echo $row["ids"];?>&realcheck=<?php echo $realcheck;?>" class ="btn btn-primary">ตรวจสอบ</a></th>
                  ...
                  <?php 
                  $check5 = $_SESSION['check5'];
                  $select_stmt = $db->prepare("SELECT * from finance WHERE check52 = $check5  ");
                  $select_stmt->execute();
              ...
              while($row = $select_stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                <th> <a href="checkwithdraw1_db.php?check_id=<?php echo $row["ids"];?>&realcheck=<?php echo $realcheck;?>" class ="btn btn-primary">ตรวจสอบ</a></th>
                  ...
                  <?php 
                  $check5 = $_SESSION['check5'];
                  $select_stmt = $db->prepare("SELECT * from finance WHERE check53 = $check5  ");
                  $select_stmt->execute();
              ...
              <?php } ?>
                  ...
                  <?php 
                  $check5 = $_SESSION['check5'];
                  $select_stmt = $db->prepare("SELECT * from finance WHERE check54 = $check5  ");
                  $select_stmt->execute();
        ...
        <?php }?>
                  ...
                  <?php 
                  $check5 = $_SESSION['check5'];
                  $select_stmt = $db->prepare("SELECT * from finance WHERE check55 = $check5  ");
                  $select_stmt->execute();
